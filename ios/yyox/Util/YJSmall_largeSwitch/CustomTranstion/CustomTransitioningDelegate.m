...
@interface PresentationVC : UIPresentationController
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source{
    CustomAnimatedTransition *startA = [[CustomAnimatedTransition alloc]init];
    TransitionHolder *holder = [TransitionHolder new];
    holder.presented = YES;
    holder.duration = self.duration;
    holder.type = self.type;
    if (self.type == TransAnimationTypeCustom && _animationIfCustom) {
...
- (id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed{
    CustomAnimatedTransition *endA = [[CustomAnimatedTransition alloc]init];
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController animationControllerForOperation:(UINavigationControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC {
    switch (operation) {
        ...
        {
            CustomAnimatedTransition *pushA = [[CustomAnimatedTransition alloc]init];
            TransitionHolder *holder = [TransitionHolder new];
            holder.presented = YES;
            holder.duration = self.duration;
            holder.type = self.type;
        ...
        {
            CustomAnimatedTransition *popA = [[CustomAnimatedTransition alloc]init];
            TransitionHolder *holder = [TransitionHolder new];
            holder.presented = YES;
            holder.duration = self.duration;
            holder.type = self.type;
...
- (void)setAnimationIfCustom:(void (^)(BOOL, UIView *, UIView *))animationIfCustom
{
    ...
    NSAssert(self.type == TransAnimationTypeCustom, @"you must set the type be AnimationTypeCustom");
