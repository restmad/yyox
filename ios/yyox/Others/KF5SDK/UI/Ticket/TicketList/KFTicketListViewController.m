...
- (void)viewDidLoad {
	...
	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"提交工单" style:UIBarButtonItemStyleDone target:self action:@selector(createTicket)];
...
- (void)createTicket
{
	KFCreateTicketViewController *create = [[KFCreateTicketViewController alloc] init];
